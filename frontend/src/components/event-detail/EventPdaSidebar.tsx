    ...
    <div className="sticky top-24 space-y-4 relative z-10">
      ...
      {canRegister ? (
        <Link
          ...
          className="block w-full text-center py-4 px-4 rounded-sm bg-primary-container text-on-primary-container font-headline font-bold tracking-widest uppercase text-sm transition-all duration-150 hover:shadow-[0_0_24px_rgba(255,107,53,0.45)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-secondary-container relative z-10"
        >
          Register now
        </Link>
      ) : (
